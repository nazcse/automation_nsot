SkyNet Bangladesh আইএসপি হিসেবে বেশ নাম করেছে। ঢাকা নর্থ জোনে মূলতঃ তাদের নেটওয়ার্ক। বর্তমানে মিরপুর এবং উত্তরায় দুটো পপ, প্রায় ৫ হাজার কাস্টমার। তারা সিদ্ধান্ত নিয়েছে এক্সেল শিট/গুগল শিট এবং হাতে আঁকা ডায়াগ্রাম ছেড়ে একটা প্রপার Network Source of Truth সিস্টেম বানাবে। তাদের লক্ষ্য পরের দুই বছরে ৫০ হাজার কাস্টমারে পৌঁছানো, আর তারপর ১ লক্ষ। এজন্য দরকার একটা শক্ত ফাউন্ডেশন। সেই ফাউন্ডেশনের নাম Nautobot 3.0।

এই চ্যাপ্টারে আমরা দেখব কীভাবে SkyNet Bangladesh তাদের নেটওয়ার্কের জন্য Nautobot 3.0 ইনস্টল এবং সেটআপ করেছে। আপনিও একইভাবে আপনার ISP-এর জন্য সেটআপ করতে পারবেন।
...
SkyNet Bangladesh এই কারণে 3.0 বেছে নিয়েছে। তারা জানে ভবিষ্যতে scaling করতে হবে, তাই শুরু থেকেই সবচেয়ে আধুনিক ভার্সন দিয়ে শুরু করছে।
...
SkyNet Bangladesh **পদ্ধতি ১** বেছে নিয়েছে — Docker + Poetry — কারণ এটা plugin management (nautobot-ssot, nautobot-chatops) এবং ভবিষ্যতে version upgrade করার জন্য অনেক বেশি সুবিধাজনক।
...
SkyNet Bangladesh এই পদ্ধতিটাই production-এ ব্যবহার করেছে। এটা official `nautobot-docker-compose` repository এবং Poetry ব্যবহার করে — plugin management এবং version upgrade অনেক সহজ হয়।

#### অটোমেটেড ডেপ্লয়মেন্ট স্ক্রিপ্ট

SkyNet Bangladesh একটা automated deployment script তৈরি করেছে যা সব কিছু একসাথে করে দেয়:
...
> ⚠️ **সতর্কতা:** Redis password-এ `@` চিহ্ন থাকলে connection URL-এ `%40` দিয়ে replace করতে হবে। যেমন `SkyNet@Redis2025$` হবে `SkyNet%40Redis2025$`। নাহলে Celery connect করতে পারবে না।
...
docker exec -it nautobot-docker-compose-nautobot-1 \
  nautobot-server createsuperuser --username newuser --email user@skynet.bd
...
Nautobot চালু হওয়ার পর SkyNet Bangladesh দুটো গুরুত্বপূর্ণ plugin যোগ করেছে।
