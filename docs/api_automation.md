...
nirvor_communication Bangladesh এখন ৫০ হাজার কাস্টমারে পৌঁছেছে। Nautobot এর ওয়েব UI দিয়ে সব কাজ করছে - ডিভাইস যোগ করা, আইপি এসাইন করা, রিপোর্ট দেখা। কিন্তু একদিন জাহাঙ্গীর সাহেব একটা সমস্যার মুখোমুখি হলেন।
...
## Nautobot connection
nb = api(
    url="https://nautobot.nirvor_communication.bd",
    token="f88c10c67357174593e09b189a57852a078bba06"
)
...
nb = api(url="https://nautobot.nirvor_communication.bd", token="your-api-token")
...
```
======================================================================
Nirvor Communication Bangladesh - Daily Network Report
...
```bash
## crontab -e
0 8 * * * /usr/bin/python3 /home/skynets/scripts/daily_report.py > /home/nirvor_communication/reports/daily_$(date +\%Y\%m\%d).txt
```
...
Nirvor Communication  Bangladesh এখন Nautobot কে অটোমেট করতে পারছে। আসিফ আর ম্যানুয়ালি ক্লিক করে সময় নষ্ট করে না। একটা স্ক্রিপ্ট লিখে সে ৫০টা ডিভাইস ৫ মিনিটে যোগ করতে পারে।
